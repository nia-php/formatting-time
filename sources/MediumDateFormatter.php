 ...
 * ru_RU: 13 дек. 2015 г.
 */
class MediumDateFormatter implements TimeFormatterInterface
{
    ...
    {
        $formatter = new IntlDateFormatter($this->locale, IntlDateFormatter::MEDIUM, IntlDateFormatter::NONE, $this->timezone, IntlDateFormatter::GREGORIAN);

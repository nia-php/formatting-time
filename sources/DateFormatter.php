 ...
 * ru_RU: 13.12.15
 */
class DateFormatter implements TimeFormatterInterface
{
    ...
    {
        $formatter = new IntlDateFormatter($this->locale, IntlDateFormatter::SHORT, IntlDateFormatter::NONE, $this->timezone, IntlDateFormatter::GREGORIAN);
